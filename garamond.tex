...
\newcommand{\tensor}[1]{\underline{\symbf{#1}}} %may need to change to renewcommand. 
...
\title{Wave Phenomena\\Problem Set 1}
...
\begin{center}
	...
	\divergence \vec{u} + \frac{\partial \rho}{\partial t} &= 0 \label{co}\\
