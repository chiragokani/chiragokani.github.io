...
%fonts:
\usepackage{fontspec} %requires compilation in XeLaTeX!!!
\usepackage[T1]{fontenc}
\usepackage{kpfonts} %Thanks to AJ Lawrence for this one
%\usepackage{baskervald} for Kyle Spratt's dissertation appearance, usse baskervald

\newfontfamily\comments{Chalkboard} %fonts for comments/change of tone
...
\newtcbox{\maybe}[1][]{%
    ...
    colback=yellow!15, boxrule=1pt,
    #1}
\newtcbox{\love}[1][]{%
    nobeforeafter, math upper, tcbox raise base,
    enhanced, colframe=pink!65!black,
    colback=pink!15, boxrule=1pt,
    #1}
\newtcbox{\eq}[1][]{%
    nobeforeafter, math upper, tcbox raise base,
...
\newtcolorbox{graytext}[2][%
    ...
    skin last=enhanced,
    ]{colframe=gray!65!black,fonttitle=\bfseries, boxrule=1pt, colbacktitle=gray!85!black,enhanced,
...
\begin{tcolorbox}\textit{These conceptual and analytical problems, which are based on Dr. Hamilton's lectures, address the major topics of the course thus far. Best wishes on the exam!}\end{tcolorbox}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This is a section. If one doesn't like the section/subsection/subsubsection formatting, one can delete these headers as well as the \texttt{\textbackslash tableofcontents}

{\comments Here are some comments,} %note that { goes OUTSIDE \comments!
and here is a centered aligned equation:
\begin{center}
\begin{tcolorbox}[ams align, width=\linewidth/2, colback=blue!10, colframe=blue!65!black]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Linearizing equations (\ref{co}) and (\ref{mo}) and combining with an equation of state gives the wave equation of linear acoustic,
