...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This is a section. If one doesn't like the section/subsection/subsubsection formatting, one can delete these headers as well as the \texttt{\textbackslash tableofcontents}. Here is a centered aligned equation:
\begin{center}
\begin{tcolorbox}[ams align, width=\linewidth/2, colback=blue!10, colframe=blue!65!black, boxrule=0.75pt]
\div u + \frac{\partial \rho}{\partial t} &= 0 \label{co}\\
\grad P + \frac{\partial }{\partial t}(\rho u) &= 0 \label{mo}
\end{tcolorbox}
\end{center}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
